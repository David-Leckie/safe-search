    ...
    methods: {
      ...
      addSite: async function() {
        ...
        try {
          ...
          dateAdded: Date(), dateUpdated: Date(), delete: false, verified: 'Yes', requestRemove: 'No'});
      ...
      dateAddedSort: async function(sites) {
        await sites.sort((a, b) => a.value.dateUpdated.localeCompare(b.value.dateUpdated)),
        await sites.reverse()
      },
...
<template>
  <body>
    <div id="mainDiv">
      ...
      <div id="authorisingMessage">SAFE Network Processing...
      </div>
      <div id="connectingMessage">Connecting to SAFE Index...
      </div>
    </div>
  </body>
</template>